...
func CreateClient() (_result *alimt20181012.Client, _err error) {
	...
	config := &openapi.Config{
		...
		AccessKeyId: tea.String(os.Getenv("LTAI5tL7H3EU5uaA7KpL51to")),
		// 必填，请确保代码运行环境设置了环境变量 ALIBABA_CLOUD_ACCESS_KEY_SECRET。
		AccessKeySecret: tea.String(os.Getenv("xP1jIiri88zTVmmMbXwtntniUqqtI0")),
	}
...
func _main(args []*string) (_err error) {
	...
	tryErr := func() (_e error) {
		...
		_, _err = client.TranslateGeneralWithOptions(translateGeneralRequest, runtime)
		if _err != nil {
			return _err
		}
